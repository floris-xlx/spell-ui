...
**Visual design.** [Typography](/blog/typography-web-design), [color](/blog/color-theory-web-design), layout, spacing, [visual hierarchy](/blog/visual-hierarchy-web-design). You need to see when something is 4 pixels off and understand why it matters.
...
**Animation and motion.** CSS transitions, keyframe animations, spring physics, [scroll-driven effects](/blog/css-animation-on-scroll). Motion is where most design-to-code handoffs break down — and the [micro-interaction details](/blog/micro-interactions-that-build-trust) are usually what separates a polished build from a flat one.
...
**Design systems are standard now.** Every company with more than a few products needs a component library. Someone has to [build those components](/blog/design-system-guide) with the same quality bar a designer would set.
