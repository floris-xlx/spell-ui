...
If you want buttons that feel more premium, animated borders and gradient hover effects add polish without heavy dependencies. Our roundup of [creative CSS hover effects for buttons](/blog/css-hover-effects-buttons) collects ten patterns you can drop in directly. This is also where I draw inspiration from component libraries like [Spell UI](https://spell.sh), which offers animated border and hover components that go beyond flat color swaps.
...
This creates a light sweep effect on hover — subtle enough for professional UIs, but noticeable enough to feel intentional. For more advanced motion you can build in your config, see our [custom animations with Tailwind CSS guide](/blog/tailwind-custom-animations).

## Dark Mode Considerations

Every variant needs dark mode treatment. For the underlying setup, see our [Tailwind dark mode guide](/blog/tailwind-dark-mode-guide). The general pattern:
