...
One of the most common carousel use cases is a scrolling row of partner or client logos. At [Spell UI](https://spell.sh), the `LogosCarousel` component handles this pattern with continuous scroll animation, automatic item duplication for gapless looping, and pause-on-hover built in. For the underlying technique, see our walkthrough on [building an infinite marquee component in React](/blog/marquee-component-react). If you're building a logo strip specifically, a dedicated component is faster to ship than adapting a general-purpose carousel — and it works well as [social proof on a landing page](/blog/landing-page-social-proof).
...
Carousels don't have to be a usability problem. With keyboard support, touch handling, and proper ARIA attributes, they can be a clean, effective way to present horizontal content without overwhelming the page. Our [accessible React components guide](/blog/react-accessibility-guide) covers the keyboard and screen reader patterns in more depth.
