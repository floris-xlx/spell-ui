...
According to Nielsen research, 92% of consumers trust recommendations from others over branded content. On a landing page, social proof is the difference between "this looks interesting" and "other people I respect use this, so it's probably good." It's one of the highest-leverage trust signals you can place — alongside the [micro-interactions and visual polish](/blog/micro-interactions-that-build-trust) that signal the same thing subconsciously.
...
**Logo bar:** Directly below the [hero](/blog/hero-section-best-practices), above the features section. It validates the headline before the visitor invests in reading more.
...
**Case studies:** Late in the page, before the [final CTA](/blog/landing-page-cta-best-practices). They provide the detailed evidence that closes the deal for hesitant visitors.
...
**Missing social proof entirely.** This is the biggest mistake. Even early-stage startups have social proof — beta user quotes, advisor endorsements, accelerator badges, or Product Hunt launch results. Use what you have. (For the broader page structure that surrounds your social proof, see our guide to [essential landing page sections](/blog/landing-page-sections).)
