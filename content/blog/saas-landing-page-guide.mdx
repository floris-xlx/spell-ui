...
The most effective SaaS hero sections follow a predictable pattern (covered in depth in our [hero section best practices guide](/blog/hero-section-best-practices)):
...
[Social proof](/blog/landing-page-social-proof) should appear within the first viewport or immediately below it. The three most effective formats:
...
Your [primary CTA](/blog/landing-page-cta-best-practices) should appear in at least three places: the hero, mid-page (after social proof or features), and the bottom of the page. Visitors who scroll to the bottom are highly engaged — don't make them scroll back up.
...
- Target a [Lighthouse](https://developer.chrome.com/docs/lighthouse) performance score above 90 (our [perfect Lighthouse score guide](/blog/lighthouse-score-guide) walks through how to get there)
...
Everything else — pricing tables, comparison charts, FAQ sections — can come after launch when you have traffic to test against. For a section-by-section reference, see our breakdown of [essential landing page sections every SaaS needs](/blog/landing-page-sections).
