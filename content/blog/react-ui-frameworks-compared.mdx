...
shadcn/ui is not a traditional library but a collection of copy-paste components built on Radix and [Tailwind CSS](https://tailwindcss.com). You own the source code directly. If you are new to the project, our deeper explainer on [what shadcn/ui actually is](/blog/what-is-shadcn-ui) walks through the philosophy in more detail.
...
**Best for:** Tailwind CSS projects where code ownership and customization matter. For a broader survey of options in this category, see our roundup of the [best Tailwind CSS component libraries](/blog/best-tailwind-component-libraries).
...
3. **Customization depth.** If your design team demands pixel-perfect custom designs, Radix primitives or shadcn/ui give you the most control. Teams going this route often pair the framework choice with a [from-scratch component library](/blog/react-component-library-guide) for shared design tokens.
