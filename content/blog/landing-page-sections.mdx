...
This is your opening argument — see our [hero section best practices guide](/blog/hero-section-best-practices) for the full breakdown. The hero section should contain:
...
Immediately below the hero, place a logo bar or metrics strip — our [landing page social proof guide](/blog/landing-page-social-proof) covers each format in detail. This answers the subconscious question: "Is anyone else actually using this?"
...
3. A visual — screenshot, illustration, or short animation (see our walkthrough on [building an animated React landing page](/blog/animated-landing-page-react))
...
- Include the same primary CTA button (our [CTA best practices guide](/blog/landing-page-cta-best-practices) covers copy and design specifics)
